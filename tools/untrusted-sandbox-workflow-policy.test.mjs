...
test('untrusted sandbox workflow pins portable protocol and live Linux isolation lanes', async () => {
  ...
  assert.match(importStep, /test "\$\(tar -tf "\$\{runtime_rootfs_tar\}"\)" = "ogvcs-output-shim"/u);
  ...
  assert.equal(importStep.match(/--change 'LABEL org\.opengamevcs\.sandbox\.runtime-contract-sha256="930be8bc4d5afb79830736fc1ef4c553dc5ef63e8a38766551cf28047752189d"'/gu)?.length, 1);
