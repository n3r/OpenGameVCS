...
export const VECTORS = {
  ...
  'production-boundaries.json': {
    ...
    cases: [
      ...
      ['transaction-credential-caller-epoch-ignored', 'DENY_EPOCH_STALE', ['OGVCS-009-FR-04', 'OGVCS-009-FR-10']],
      ['transaction-view-resource-substitution', 'DENY_NOT_AUTHORIZED', ['OGVCS-009-FR-04', 'OGVCS-009-FR-05']],
      ['transaction-decision-commitment-same-tx', 'committed', ['OGVCS-009-FR-04', 'OGVCS-009-FR-08']],
      ['trusted-checkpoint-request-substitution', 'AUDIT_INTEGRITY', ['OGVCS-009-FR-08']],
