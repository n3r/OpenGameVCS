...
export const SELECTION_BENCHMARK_THRESHOLDS = Object.freeze({
  ...
  entries: [
    ...
    { id: 'source-like-retains-material-reuse', requirementId: 'OGVCS-007-FR-08', workloadId: 'source-like', metric: 'reusedBytes', operator: 'minimum', value: 4000000, severity: 'gate' },
    { id: 'structured-retains-material-reuse', requirementId: 'OGVCS-007-FR-08', workloadId: 'structured', metric: 'reusedBytes', operator: 'minimum', value: 14000000, severity: 'gate' },
    { id: 'compressed-observes-poor-reuse', requirementId: 'OGVCS-007-AC-04', workloadId: 'already-compressed', metric: 'reusedBytes', operator: 'maximum', value: 262144, severity: 'gate' },
    { id: 'random-observes-no-reuse', requirementId: 'OGVCS-007-AC-04', workloadId: 'encrypted-random', metric: 'reusedBytes', operator: 'maximum', value: 0, severity: 'gate' },
    { id: 'insertion-resynchronizes-boundedly', requirementId: 'OGVCS-007-AC-04', workloadId: 'insertion', metric: 'resynchronizationDistanceBytes', operator: 'maximum', value: 1048576, severity: 'gate' },
    { id: 'replacement-resynchronizes-boundedly', requirementId: 'OGVCS-007-AC-04', workloadId: 'replacement', metric: 'resynchronizationDistanceBytes', operator: 'maximum', value: 1572864, severity: 'gate' },
    { id: 'append-limits-new-tail-bytes', requirementId: 'OGVCS-007-FR-08', workloadId: 'append', metric: 'newlyRequiredBytes', operator: 'maximum', value: 2097152, severity: 'gate' },
  ],
});
